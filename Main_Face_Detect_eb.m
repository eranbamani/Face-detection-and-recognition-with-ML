...
% =========================================================================
% Preprocessing
path = ('C:\Users\97252\Desktop\image processing\exercise\5\file\face\*.jpg');
read_face = dir(path);
len_face = 440;%length(read_face);
pat = dir('C:\Users\97252\Desktop\image processing\exercise\5\file\face');
a = pat(1).folder;
% 
path2 = ('C:\Users\97252\Desktop\image processing\exercise\5\file\image\*.jpg');
read_img = dir(path2);
len_img = 443;%length(read_img);
total = len_face + len_img;
pat2 = dir('C:\Users\97252\Desktop\image processing\exercise\5\file\image');
b = pat2(1).folder;
% -------------------------------------------------------------------------
% data
width = 100;
